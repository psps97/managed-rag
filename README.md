...
[create_data_source](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/bedrock-agent/client/create_data_source.html)

## 데이터 소스 동기화

Boto3의 을 이용하여 데이터 동기화를 요청합니다.
